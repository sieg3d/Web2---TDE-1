...
document.write(`<br>O número digitado foi: ${a}`)
...
document.write(`<br>${m} metros equivale a ${m * 100} centimetros e consequentemente ${m * 1000} milimetros.`)
...
c = 5 * ((f - 32) / 9)
document.write("A conversão de ", f, "F é: ", c.toFixed(2), "C")
